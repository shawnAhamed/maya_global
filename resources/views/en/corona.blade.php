...
<section id="second">
    <div class="mycontainer">
        <div class="mycontainer" style="height:90px">
            <div class="grid-3-1" style="width:900px">
                <nav class="navbar navbar-expand-lg navbar-light" style="padding-top:10px">
                    ...
                    <a class="navbar-brand" href="/corona" style="margin-left: -20px;font-size: 30px;font-weight: 500;line-height: 60px">Corona Virus</a>
                    <div class="" id="">
        ...
        <div class="mycontainer text-center" style="background-color: #ffffff">
            <h1 style="color:#613ABD;font-size:80px;font-weight: bold;line-height: 97px">
                Please do not go to <br> hospital.<u>It could be dangerous for you.</u>
            </h1>
            <h1 style="font-size:50px;color: #363636;margin-top: 30px">Maya is here to help and you can get it from home.</h1>
        </div>
