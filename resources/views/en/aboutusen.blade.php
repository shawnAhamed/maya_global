...
{{--        <img src="/img/seminar.png" style="">--}}
    ...
    <div class="mycontainer" style="">
        ...
        <div class="speach-ceo" style="float: left;margin-left: 30px;">
...
<section class="teamsection" style="background-color:#F0F0F0;margin-top:-105px">
    <div class="mycontainer text-center">
        ...
        <p style="font-size: 24px;font-weight: bold;margin-top:60px">Leadership</p>
            <hr style="border: transparent;border-bottom: 1px dashed #707070;">
            ...
            <p style="font-size: 24px;font-weight: bold;margin-top:60px">Team Maya</p>
            <hr style="border: transparent;border-bottom: 1px dashed #707070;">
