                    ...
                    <li class=" float-left dropdown">
                        ...
                        <div>
                            ...
                            <div class="dropdown-content" >
                                <a href="/bn" style="font-size: 16px;color: #363636;padding:15px 20px 0px 0px;font-family:Hind Siliguri">বাংলা</a>
...
<section class="experts-banner">
    ...
    <div class="mycontainer">
        ...
        <div style="height: 296px;margin-top:40px;">
            ...
            <div class="experthuming">

                <p style="font-size: 30px;line-height:36px;color: #707070;">The Hummingbird is a symbol of freedom. In our example it is a goal focused and highly active bird. The Maya Apa staff are just like the Hummingbird. We work with freedom, share our focused thoughts and contribute to taking Maya Apa to the next level.</p>
            </div>
        </div>
