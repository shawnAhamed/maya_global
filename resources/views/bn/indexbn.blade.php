    ...
    <div class="mycontainer">
        ...
        <div class="" style="width:570px;float: right;margin-left:20px;">
            <div style="width:21px;float:left;">
                <img src="../img/icon/icon_article.png" style="float:left;height: 21px;width: 24px;margin-top:25px;"/>
            </div>
            <div style="width:545px;float: right;margin-top:20px;padding-left: 20px;">
                <p style="font-size:16px;color: #707070;line-height:20px;font-weight: bold">করোনাভাইরাস সংক্রান্ত দুশ্চিন্তায় আপনাকে সাহায্য করতে মায়া প্রস্তুত, প্রশ্ন করুন আর মাত্র ১৫ মিনিটে উত্তর পান!</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="mycontainer">
        ...
        <div class="experservice">
            <div class="text-center">
                ...
                <div class="caption">
                    <p style="font-size:24px;color: #363636;">বিশেষজ্ঞ পরামর্শ</p>
                    <p style="font-size:36px;font-weight:bold;color: #363636;line-height:20px">২০০,০০০</p>
                    <p style="font-size:20px;line-height:24px;color: #363636">শারীরিক ও মানসিক স্বাস্থ্য বিষয়ক প্রতি মাসের বিশেষজ্ঞ পরামর্শ।</p>
                </div>
            </div>
        </div>
    ...
    <div class="mycontainer">
        <div class="" style="height:1020px">
            ...
            <div class="mobilebannercnt" style="margin-top:80px">
                ...
                <p style="font-size:30px;font-weight: 400;color: #A64DA3;line-height: 48px">৩ মিলিয়ন মাসিক সক্রিয় গ্রাহক </p>
