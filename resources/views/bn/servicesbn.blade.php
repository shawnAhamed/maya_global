...
<head>
    ...
    <title>মানুষের সেবায় মায়া</title>
    <meta name="description" content="আমরা প্রতিমাসে ৩,০০০,০০০ এর অধিক গ্রাহককে সেবা দিয়ে থাকি।">
            ...
            <div class="menudiv">
                <div class="menuitems">
                    <ul class="float-right" style="color: #ffffff">
                        ...
                        <li class=" float-left">
                            <a class="anchor active" href="/bn/services">পরিষেবা</a>
                        </li>
                        <li class=" float-left">
...
<section class="servicetag">
    <div class="mycontainer">
        <p style="font-size:80px;line-height:110px;font-weight: bold;color: #613ABD;padding-top: 60px">আমরা প্রতিমাসে <u>৩,০০০,০০০</u> এর অধিক গ্রাহককে সেবা দিয়ে থাকি।</p>
    ...
    <div class="mycontainer" style="height: 240px">
        <div class="grid-6-1 text-center">
            ...
            <div class="servicedesc">
                <p class="thumsubheader-service">আমাদের স্বয়ংক্রিয় বট সাধারণ স্বাস্থ্য সংক্রান্ত বিষয়ে তাৎক্ষণিক তথ্য দেয়।</p>
            </div>
        </div>
        <div class="grid-6-2 text-center">
            <img src="/img/servicepage/sqa.png">
            <div class="" style="margin-top: 43px">
                <p class="thumsubheader-service">আপনার পরিচয় গোপন রেখে প্রশ্ন করুন এবং বিশেষজ্ঞের পরামর্শ নিন</p>
            </div>
        </div>
        <div class="grid-6-3 text-center">
            <img src="/img/servicepage/sphn.png">
            <div class="servicedesc">
                <p class="thumsubheader-service">সরাসরি ডাক্তারের সাথে কথা বলুন, প্রয়োজনে প্রেসক্রিপশন নিন। </p>
            </div>
        </div>
        <div class="grid-6-4 text-center">
            <img src="/img/servicepage/shealth.png">
            <div class="servicedesc">
                <p class="thumsubheader-service">মানসিক স্বাস্থ্য সংক্রান্ত বিভিন্ন ধরণের সেবা আমরা দিয়ে থাকি।</p>
            </div>
        </div>
        <div class="grid-6-5 text-center">
            <img src="/img/servicepage/sshop.png">
            <div class="servicedesc">
                <p class="thumsubheader-service">আপনার ব্যক্তিগত পণ্য অর্ডার করুন, গোপনীয়তার সাথে পৌঁছে দেয়া হবে।</p>
            </div>
        </div>
        <div class="grid-6-6 text-center">
            <img src="/img/servicepage/sheart.png">
            <div class="" style="margin-top:37px">
                <p class="thumsubheader-service">আমাদের বিভিন্ন তথ্য পড়ুন, আপনার স্বাস্থ্য সম্পর্কে আরো ভালো জানুন।</p>
            </div>
        </div>
    </div>
    <div class="mycontainer" style="height: 240px;">
        <div class="grid-6-2-3 text-center">
            ...
            <div class="" style="margin-top:40px">
                <p class="thumsubheader-service">মায়া বিশেষজ্ঞ হিসেবে যোগ দিন, পরিবর্তনের অংশীদার হয়ে যান।</p>
            </div>
        </div>
        <div class="grid-6-2-4 text-center">
            <img src="/img/servicepage/skiosk.png">
            <div class="servicedesc">
                <p class="thumsubheader-service">মায়া কিয়স্ক আপনার ব্যবসায় যুক্ত করুন, সুস্থ্য কর্মীবাহিনী তৈরী করুন।</p>
            </div>
        </div>
    </div>
</section>
...
<section class="appshow" style="height:980px;background-color: #613ABD">
    ...
    <div style="text-align: center;margin-top:120px">
        <p style="font-size: 48px;line-height: 58px;color: #ffffff;margin-top: 60px">এক অ্যাপে সবকিছু, সহজে।</p>
        ...
        <p style="font-size:24px;line-height:37px;color:#BFB1E0">স্বাস্থ্য, জীবনধারা এবং ভালো থাকা নিয়ে সচেতন বাংলা ভাষাভাষী সবচেয়ে বড় জনগোষ্ঠীর সাথে যুক্ত হোন,<br> অভিজ্ঞতা বিনিময় করুন।</p>
...
<section class="joinmaya">
    <div class="mycontainer">
        ...
        <h1 class="jonmayatext">মায়া’তে বিশেষজ্ঞ হিসেবে যোগ দিতে চান?</h1>
        ...
        <div class="joinmayabtn" style="text-align: center;margin-top:50px;">
            <a href="https://maya.com.bd/become/mayaapa" class="joinmayabtntxt" style="text-decoration: none;">এখনই যোগ দিন!</a>
        </div>
    </div>
        ...
        <div class="mycontainer">
            <div class="" style="width:750px;margin-left: 200px">
                ...
                <div style="margin-top: 30px">
                    <p style="font-size: 70px;font-weight:500;color:#314AC4">মায়া কিয়স্ক</p>
                    <p style="font-size:30px;font-weight:400;line-height:47px;color:#363636">আপনার ব্যবসায়িক কর্মপরিবেশে স্থাপনের জন্য নির্মিত যা থেকে আপনার কর্মীবাহিনী সাধারণ স্বাস্থ্য সেবা গ্রহণ করতে পারে।</p>
                </div>

                <div style=" margin-top:60px">
                    <a class="bannerbtn" href="mailto:kiosk@maya.com.bd" target="_blank"  style="border-radius:8px;padding:22px 45px;background-color:#ffffff;color:#363636;font-size:16px;text-decoration: none;line-height:36px;font-weight:500;width:170px">পরখ করে দেখুন</a>
                    <a class="bannerbtn" href="https://bit.ly/3d9CtXo" target="_blank" style="border-radius:8px;padding:22px 35px;background-color:#C94D5E;color: #ffffff;font-size: 16px;line-height:36px;font-weight:500;margin-left:30px;text-decoration: none;width:170px">বিভিন্ন সুবিধাসমূহ</a>
                </div>
                <p style="font-size:16px;font-weight:500;line-height: 36px;color: #363636;margin-top:30px">ব্যবসার জন্য নির্মিত অন্যান্য সরঞ্জাম সম্পর্কে জানুন।</p>
